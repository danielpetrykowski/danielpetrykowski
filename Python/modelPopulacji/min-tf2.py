...
W_z2 = tf.Variable(W_initial, "W_z2")
W_d2 = tf.Variable(W_initial, "W_d2")
b_2 = tf.Variable(b_initial, "b_2")

W_3 = tf.Variable(W_initial, "W_3")
b_3 = tf.Variable(b_initial, "b_3")
...
saver = tf.train.Saver({"myW_d": W_d, "myb_d": b_d, "myW_z": W_z, "b_z": b_z, "myW_z2": W_z2, "myb_2": b_2, "myW_d2": W_d2, "b_3": b_3, "myW_3": W_3})

if a == 1:
    sprawdzam = 0
else:
    plik = open('iteracje.txt')
    try:
        tekst = plik.read()
    finally:
        plik.close()
